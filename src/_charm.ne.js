...
var grammar = {
    Lexer: undefined,
    ParserRules: [
    {"name": "program", "symbols": ["charmName", "newline", "charmDetails", "description"]},
    {"name": "charmName", "symbols": ["singleLineText"], "postprocess": id},
    {"name": "charmDetails", "symbols": ["cost", "mins", "newline", "charmType", "newline", "keywords", "newline", "duration", "newline", "prereqs", "newline"]},
    ...
    {"name": "charmType", "symbols": ["charmType$string$3"], "postprocess": function(d) {return d[0].join("").join("") }},
    ...
    {"name": "prereqs", "symbols": ["prereqs$string$1"]},
