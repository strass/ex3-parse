...
var grammar = {
    ...
    {"name": "charmDetails$string$1", "symbols": [{"literal":"T"}, {"literal":"y"}, {"literal":"p"}, {"literal":"e"}, {"literal":":"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "charmDetails$string$2", "symbols": [{"literal":"K"}, {"literal":"e"}, {"literal":"y"}, {"literal":"w"}, {"literal":"o"}, {"literal":"r"}, {"literal":"d"}, {"literal":"s"}, {"literal":":"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "charmDetails$string$3", "symbols": [{"literal":"D"}, {"literal":"u"}, {"literal":"r"}, {"literal":"a"}, {"literal":"t"}, {"literal":"i"}, {"literal":"o"}, {"literal":"n"}, {"literal":":"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "charmDetails$string$4", "symbols": [{"literal":"P"}, {"literal":"r"}, {"literal":"e"}, {"literal":"r"}, {"literal":"e"}, {"literal":"q"}, {"literal":"u"}, {"literal":"i"}, {"literal":"s"}, {"literal":"i"}, {"literal":"t"}, {"literal":"e"}, {"literal":" "}, {"literal":"C"}, {"literal":"h"}, {"literal":"a"}, {"literal":"r"}, {"literal":"m"}, {"literal":"s"}, {"literal":":"}, {"literal":" "}, {"literal":"N"}, {"literal":"o"}, {"literal":"n"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "charmDetails", "symbols": ["cost", "mins", "newline", "_", "charmDetails$string$1", "_", "charmType", "_", "newline", "_", "charmDetails$string$2", "_", "keywords", "newline", "_", "charmDetails$string$3", "_", "duration", "newline", "_", "charmDetails$string$4"]},
    ...
    {"name": "keywords$string$1", "symbols": [{"literal":"N"}, {"literal":"o"}, {"literal":"n"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "keywords", "symbols": ["keywords$string$1"]},
    {"name": "keywords$string$2", "symbols": [{"literal":"D"}, {"literal":"u"}, {"literal":"a"}, {"literal":"l"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "keywords", "symbols": ["keywords$string$2"]},
    {"name": "duration$ebnf$1", "symbols": ["word"]},
    {"name": "duration$ebnf$1", "symbols": ["duration$ebnf$1", "word"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "duration", "symbols": ["duration$ebnf$1"]},
    {"name": "requirement", "symbols": ["requirementType", "__", "number"]},
